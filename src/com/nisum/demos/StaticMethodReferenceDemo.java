...
public class StaticMethodReferenceDemo {
    ...
    // This method takes a functional interface as the type of its first parameter.
    // Thus it can accept a reference to any instance of that
    ...
    public static void main(String[] args) {
        ...
        result = demo.numCheck(IntPredicateCheckerForStaticMethodReference::isEven, num);
        ...
        result = demo.numCheck(IntPredicateCheckerForStaticMethodReference::isPositive, num);
